...
class inputPinjam extends Component {

    static navigationOptions = {
        title: 'Input Data Pinjam',
        headerStyle: {
            ...
            <Container style={{ flex: 1 }}>
                <Content contentContainerStyle={{
                    ...
                    <TouchableOpacity
                            ...
                            <Text style={styles.TextStyle}>Tambah Data Peminjam</Text>
                        </TouchableOpacity>
                </Content>
            </Container>
