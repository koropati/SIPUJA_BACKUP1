            ...
            >
                <View style={styles.overlayContainer}>
                    ...
                    <View style={styles.bottom}>
                        ...
                        <TouchableOpacity style={styles.bottomItemLeft} onPress={() => this.props.navigation.navigate('inputPinjam')}>
                            <View style={{ flex: 1, flexDirection: 'row', backgroundColor: '#2B5E8A' }} >
                                <View style={{ width: 100, height: '100%' }}>
                                    ...
                                    <Text style={{ color: '#FFF', marginLeft: 10, marginTop: 10, fontSize: 10, }}>Peminjaman</Text>
                                </View>
                                <View style={{ width: '100%', height: '100%' }}>
                                    <Text style={styles.judulMenu}>Input Data</Text>
                                    <Text style={{ color: '#FFF', marginTop: 5, fontSize: 18, fontWeight: 'bold' }}>Peminjam</Text>
                                </View>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.bottomItemRight} onPress={() => this.props.navigation.navigate('inputKembali')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemLeft} onPress={() => this.props.navigation.navigate('inputBuku')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemRight} onPress={() => this.props.navigation.navigate('dataBuku')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemLeft} onPress={() => this.props.navigation.navigate('cariBuku')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemRight} onPress={() => this.props.navigation.navigate('dataPinjam')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemLeft} onPress={() => this.props.navigation.navigate('tambahAnggota')}>
                        ...
                        <TouchableOpacity style={styles.bottomItemRight} onPress={() => this.props.navigation.navigate('dataAnggota')}>
